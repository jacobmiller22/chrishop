...
Shopify via the Storefront API separates the *presentation layer* (our Next.js/Cloudflare app) from the *commerce layer* (Shopify's managed checkout, payments, inventory, and orders). Benefits:
