...
export const HardwareVaultLayout: React.FC<HardwareVaultLayoutProps> = ({ products }) => {
  return (
    <div className="w-full min-h-screen bg-[#08090B] text-[#E2E8F0] selection:bg-[#F59E0B] selection:text-black font-mono-vault">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 h-20 flex items-center justify-between">
          <div className="flex items-center gap-6">
            <Link href="/" className="group flex items-center gap-3">
              <div className="w-8 h-8 bg-[#181B20] border border-[#F59E0B]/50 flex items-center justify-center text-[#F59E0B] font-bold text-xs">
                &gt;_
              </div>
              <div className="flex flex-col">
                <span className="font-cypher-vault text-xl uppercase font-bold tracking-wider text-white group-hover:text-[#F59E0B] transition-colors leading-none">
                  BANKBEATERS // VAULT
                </span>
                <span className="text-[10px] tracking-widest text-[#64748B] uppercase pt-1">
          ...
          <nav className="flex items-center gap-8 text-xs uppercase tracking-wider text-[#94A3B8]">
            <a href="#schematics" className="hover:text-[#F59E0B] transition-colors">
              [SCHEMATICS]
            </a>
            ...
            <Link
              href="/cart"
              className="px-3.5 py-1.5 border border-[#F59E0B]/40 bg-[#12151A] hover:bg-[#F59E0B] text-[#F59E0B] hover:text-black font-bold transition-all flex items-center gap-2"
            >
              <span className="text-[11px]">PAYLOAD</span>
              <span className="text-[10px] bg-black/50 px-1.5 py-0.5 rounded text-white">0</span>
            </Link>
          </nav>
        </div>
      </header>
      ...
      <section className="border-b border-[#1E232A] bg-[#0E1116] px-6 lg:px-12 py-3">
        <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-between gap-4 text-xs">
          <div className="flex flex-wrap items-center gap-4 text-[#94A3B8]">
            ...
            <div>
              ...
              <span className="text-emerald-400">JUKI DDL INDUSTRIAL RUN</span>
            </div>
            <span className="text-[#334155] hidden sm:inline">|</span>
            <div>
              <span className="text-[#64748B]">QUEUE DISPATCH:</span>{' '}
      ...
      <section className="relative w-full border-b border-[#1E232A] bg-[#0A0D12] py-16 lg:py-24 px-6 lg:px-12">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          {/* Left HUD Narrative */}
          <div className="lg:col-span-7 space-y-8">
            <div className="inline-flex items-center gap-3 bg-[#131822] border border-[#1E283A] px-3.5 py-1.5">
              <span className="text-[#06B6D4] font-bold text-xs uppercase tracking-widest">
                OPTION C // HARDWARE VAULT &amp; DENSE BOM ARCHITECTURE
              </span>
            </div>

            <div className="space-y-4">
              <span className="text-xs uppercase tracking-[0.25em] text-[#F59E0B] block font-bold">
                HIGH-DENSITY HARDWARE TELEMETRY
              </span>
              <h1 className="font-cypher-vault text-5xl sm:text-7xl lg:text-8xl font-bold uppercase tracking-tight text-white leading-none">
                Curiosity &gt; Fear.
              </h1>
              <p className="text-sm sm:text-base text-[#94A3B8] leading-relaxed max-w-xl pt-2 font-mono-vault">
            ...
            <div className="pt-2 flex flex-wrap items-center gap-5">
              <a
                href="#schematics"
                className="px-8 py-4 bg-[#F59E0B] hover:bg-[#D97706] text-black font-cypher-vault text-base uppercase font-bold tracking-wider transition-all duration-200 shadow-lg shadow-[#F59E0B]/20"
              >
                Access Equipment Vault ({products.length})
              </a>
              <Link
                href="/about"
                className="px-8 py-4 border border-[#334155] hover:border-[#F59E0B] bg-[#12151A] hover:bg-[#181B20] text-white font-cypher-vault text-base uppercase font-bold tracking-wider transition-all duration-200"
              >
            ...
            {/* Tactical Live Specs */}
            <div className="pt-6 border-t border-[#1E232A] grid grid-cols-3 gap-6 text-xs text-[#64748B]">
              <div>
                <span className="block text-[#F59E0B] font-bold text-sm uppercase">20K / 20K</span>
                <span className="text-[11px]">Toray 3L Shield</span>
              </div>
              <div>
                <span className="block text-[#F59E0B] font-bold text-sm uppercase">500D / 1000D</span>
                <span className="text-[11px]">Mil-Spec Cordura</span>
              </div>
              <div>
                <span className="block text-[#F59E0B] font-bold text-sm uppercase">SERIALIZED</span>
                <span className="text-[11px]">2 to 6 Units Per Drop</span>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-5">
            <div className="relative bg-[#0E1218] border border-[#263040] p-3 shadow-2xl group">
              ...
              {/* Footer HUD */}
              <div className="mt-3 p-3 bg-[#121620] border border-[#1E283A] flex items-center justify-between text-xs">
                <div>
      ...
      <section className="py-20 px-6 lg:px-12 border-b border-[#1E232A] bg-[#0A0C10]">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-[#0E1117] border border-[#1E232A] p-6 space-y-4">
            <span className="text-xs text-[#F59E0B] font-bold block uppercase">
              MODULE 01 // BALLISTIC RESILIENCE
            </span>
            <h3 className="font-cypher-vault text-xl font-bold uppercase text-white">
      ...
      <section id="schematics" className="py-24 px-6 lg:px-12 bg-[#08090B]">
        <div className="max-w-7xl mx-auto space-y-16">
          <div className="flex flex-col sm:flex-row justify-between items-baseline gap-4 border-b border-[#1E232A] pb-6">
            <div>
              <span className="text-xs uppercase tracking-[0.25em] text-[#F59E0B] font-bold block">
                BOM &amp; HARDWARE INVENTORY
              </span>
              <h2 className="font-cypher-vault text-4xl sm:text-5xl font-bold uppercase tracking-tight text-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {products.map((product, idx) => {
              ...
              return (
                <div
                  key={product.id}
                  className="bg-[#0D1016] border border-[#1E232A] hover:border-[#F59E0B] transition-all duration-300 p-5 space-y-5 flex flex-col justify-between"
                >
                  ...
                  <div className="space-y-3">
                    <div>
                      <h4 className="font-cypher-vault text-lg font-bold uppercase text-white truncate">
                        {product.title}
                      </h4>
                    ...
                    <div className="p-3 bg-[#08090B] border border-[#1E232A] text-xs space-y-1.5">
                    ...
                    <div className="flex items-center justify-between pt-2">
                      <span className="text-base font-bold text-white font-cypher-vault">
                        ${product.base_price.toFixed(2)}
                      </span>
                      <Link
                        href={`/products/${product.slug}`}
                        className="px-3.5 py-1.5 bg-[#181B20] hover:bg-[#F59E0B] text-[#94A3B8] hover:text-black text-xs font-bold transition-colors border border-[#334155]"
                      >
                        [INSPECT SPEC] →
                      </Link>
                    </div>
      ...
      <footer className="border-t border-[#1E232A] py-16 px-6 lg:px-12 bg-[#050608]">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6 text-xs text-[#64748B]">
